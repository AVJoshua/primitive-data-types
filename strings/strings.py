...
newString = "This is a Python string"
...
lastCharacter = getLastCharacter[len(getLastCharacter) - 1]
...
lastFourCharacters = getLastFourCharacters[len(getLastFourCharacters) - 4:len(getLastFourCharacters) - 0]
...
testString2 = testString2[:].replace("first sentence.", "second best,").replace("second sentence", "first best!").lower()
