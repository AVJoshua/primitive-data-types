...
let lastCharacter = getLastCharacter[getLastCharacter.length - 1]
...
let lastSixCharacters = getLastSixCharacters.slice(getLastSixCharacters.length - 6, getLastSixCharacters.length - 0)
...
testString2 = testString2.replace("first sentence.", "second best,").replace("second sentence", "first best!").toLowerCase()
